...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[__SQLXMLBulkload_22135585574118_] (
...
GO
CREATE CLUSTERED INDEX [__SQLXMLBulkload_22135585574118__index]
	ON [dbo].[__SQLXMLBulkload_22135585574118_] ([TempId])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[__SQLXMLBulkload_22135585574118_] SET (LOCK_ESCALATION = TABLE)
GO

...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Statistiques_Avancement_Projets_Details1] (
...
GO
ALTER TABLE [dbo].[Statistiques_Avancement_Projets_Details1]
	ADD
	CONSTRAINT [PK__Statisti__7A54AA577756E0C6]
	PRIMARY KEY
	CLUSTERED
	([id_statistiques_avancement_projets_details])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[Statistiques_Avancement_Projets_Details1] SET (LOCK_ESCALATION = TABLE)
GO

...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[__SQLXMLBulkload_21119307955318_] (
...
GO
CREATE CLUSTERED INDEX [__SQLXMLBulkload_21119307955318__index]
	ON [dbo].[__SQLXMLBulkload_21119307955318_] ([TempId])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[__SQLXMLBulkload_21119307955318_] SET (LOCK_ESCALATION = TABLE)
GO

...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[AEL_Parametres] (
...
GO
ALTER TABLE [dbo].[AEL_Parametres]
	ADD
	CONSTRAINT [PK_AEL_Parametres]
	PRIMARY KEY
	CLUSTERED
	([id_ael_parametres])
	ON [PRIMARY]
...
ALTER TABLE [dbo].[AEL_Parametres]
	ADD
	CONSTRAINT [DF_AEL_Parametres_date_creation_ael_parametres]
	DEFAULT (getdate()) FOR [date_creation_ael_parametres]
GO
ALTER TABLE [dbo].[AEL_Parametres]
	ADD
	CONSTRAINT [DF_AEL_Parametres_principal]
	DEFAULT ((0)) FOR [principal]
GO
ALTER TABLE [dbo].[AEL_Parametres] SET (LOCK_ESCALATION = TABLE)
GO

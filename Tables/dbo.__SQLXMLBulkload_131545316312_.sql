...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[__SQLXMLBulkload_131545316312_] (
...
GO
CREATE CLUSTERED INDEX [__SQLXMLBulkload_131545316312__index]
	ON [dbo].[__SQLXMLBulkload_131545316312_] ([TempId])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[__SQLXMLBulkload_131545316312_] SET (LOCK_ESCALATION = TABLE)
GO

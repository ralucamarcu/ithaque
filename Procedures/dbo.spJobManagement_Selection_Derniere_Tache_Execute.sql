...
-- =============================================
CREATE PROCEDURE spJobManagement_Selection_Derniere_Tache_Execute 
...
BEGIN
	...
	SELECT TOP 1 job_name, [enabled], start_execution_date, stop_execution_date, last_outcome, last_outcome_message, last_run_duration
		, last_run_date, sql_severity_error, step_message, run_step_status
	FROM #tmp
	WHERE job_name LIKE 'AEL%' OR job_name LIKE '%import%'
	ORDER BY start_execution_date DESC, stop_execution_date DESC

...
-- =============================================
CREATE PROCEDURE [dbo].[spStatistiquesControleQualiteParProjet_v]
...
BEGIN
	...
	, taux_lots_rejetes FLOAT, actes_controles INT, actes_valides int,lots_livres INT, actes_rejetes int, taux_actes_rejetes float,taux_lots_controles float,id_echantillon INT)
...
--	while (select COUNT(*) from #tmp) >0
	...
	begin
		...
		INSERT INTO #Statistiques_Controle_Projet (sous_projet, livraison, lots_controles, lots_valides, lots_rejetes
				, taux_lots_rejetes, actes_controles, actes_valides, actes_rejetes, lots_livres,taux_lots_controles, taux_actes_rejetes/*,id_echantillon*/)
